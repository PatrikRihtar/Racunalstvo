...

{
	...
	cout<<endl;
	cout<<"Najmanji broj u vektoru je: "<<*min_element(PR.begin(), PR.end())<<" ."<<endl;
	cout<<"Najveci broj u vektoru je: "<<*max_element(PR.begin(), PR.end())<<" ."<<endl;
	vector<int>::iterator ip;
	ip=unique(PR.begin(), PR.end());
	PR.resize(distance(PR.begin(), ip));
	cout<<"Brojevi bez ponavljanja su:"<<endl;
	for (ip=PR.begin(); ip!=PR.end(); ip++)
	{
		cout<<*ip<<" ";
	}
	return 0;
